...
bool ZombieOutskirts::MouseOnAnyButton(sf::RenderWindow& window, int x)
{
...
void ZombieOutskirts::Highligh_Buttons(int x)
{
	button[x]->Highlight();
}

void ZombieOutskirts::original_Buttons(int x)
{
	button[x]->Original();
}


void ZombieOutskirts::CreateZombies()
{
	for (int i = 0;i < 10; i++)
	{
		int r;
...
void ZombieOutskirts::DrawInventory(sf::RenderWindow& window) {
	this->inventory->draw(window);
}

void ZombieOutskirts::DrawZombies(sf::RenderWindow& window)
{
	for (int i = 0; i < 40; i++)
	{
		if (factory.getZombie(i) != NULL) {
...
void ZombieOutskirts::moveZombies(sf::RenderWindow& window)
{
	for (int i = 0; i < 40; i++)
	{
		if (factory.getZombie(i) != NULL) {
...
bool ZombieOutskirts::LevelCompleted()
{
	for (int i = 0; i < 40; i++)
	{
		if (factory.getZombie(i) != NULL) {
...
void ZombieOutskirts::handleSuns()
{

}

void ZombieOutskirts::handleMowers(sf::RenderWindow& window)
{
	for (int i = 0; i < 5; i++)
	{
...
void ZombieOutskirts::ManageInteractions(sf::RenderWindow& window)
{
	for (int i = 0; i < 20; i++)
	{
		if (factory.getZombie(i) != NULL) {
...
bool ZombieOutskirts::getZombieEnteredHouse()
{
